...
function Item({ contentsLeft, contentRight, number }) {
  return (
    <div className="relative gap-6 flex justify-center text-center items-center">
      ...
      <div className="font-lobster-two absolute sm:w-[62.59px] w-[52.59px] h-[52.59px] sm:h-[62.59px] rounded-[50%] bg-white flex justify-center items-center size-[30px] font-[700] leading-[37.5px]">
        {number}
      </div>
